...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      {/* Navigation */}
      <nav className={cn("flex-1 space-y-1.5 py-8", collapsed ? "px-2" : "px-4")}>
        {navigation.map((item) => {
      ...
      {!collapsed && (
        <div className="p-6">
          <div className="rounded-2xl border border-white/5 bg-[#0F1B2D] p-5 shadow-xl">
            ...
            <div className="mt-5 text-[11px] font-medium text-[#7C8BA1] pl-5">Version 1.0.0</div>
          </div>
        </div>
      )}
