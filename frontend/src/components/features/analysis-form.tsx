  ...
  return (
    <div className="rounded-[12px] border border-white/5 bg-[#0F1B2D] shadow-xl p-6 mb-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6 items-end">
        {/* Entry Day */}
        <div className="space-y-1.5">
          <label className="text-[11px] font-bold text-[#7C8BA1] uppercase tracking-wider ml-1">Entry Day</label>
          <select 
            className={cn(inputClasses, "appearance-none bg-[#07111F]")}
            value={entryWeekday}
        ...
        {/* Exit Day */}
        <div className="space-y-1.5">
          <label className="text-[11px] font-bold text-[#7C8BA1] uppercase tracking-wider ml-1">Exit Day</label>
          <select 
            className={cn(inputClasses, "appearance-none bg-[#07111F]")}
            value={exitWeekday}
        ...
        {/* Run Analysis */}
        <div className="flex-none pt-4 xl:pt-0">
          <button
